# 블로그 폴더 설명 (agd.trip-offer.co.kr)
...
주소는 `https://agd.trip-offer.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://agd.trip-offer.co.kr/blog/agoda-coupon/ |
...
- 포인트 색: **#2A72E5** (blue-600) — `blog.css` 맨 위 `--blog-point`
